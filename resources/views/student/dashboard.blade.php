        ...
        <div class="owl-carousel owl-theme w-100">
            ...
            <div class="item h-100">
                <div class="card d-lg-inline-block border-0 ms-2 me-2 pt-3 pb-2 ps-1 pe-1">
                    ...
                    <a href="{{ route('student.selecttelim', ['id'=>$telim->id]) }}" class="btn btn-primary w-100 pt-2 pb-2 border-0 text-dark" id="cardTransition">Dərslərə keçid</a>
                </div>
            </div>
            @endforeach
        </div>
        ...
        <div class="owl-carousel owl-theme w-100">
            ...
            <div class="item">
                <div class="card d-lg-inline-block border-0 ms-2 me-2 pt-3 pb-2 ps-1 pe-1">
                    ...
                    <a href="{{ route('student.selectMentor', ['id'=>$telimci->id]) }}" class="btn btn-primary w-100 pt-2 pb-2 border-0 text-dark" id="cardTransition">Ətraflı</a>
                </div>
            </div>
