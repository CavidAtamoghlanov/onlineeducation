    ...
    <div class="container d-flex flex-row flex-wrap pt-5 justify-content-start align-content-center">
        <div class="me-5 mb-4 text-light">
            ...
            <ul class="d-flex flex-column flex-wrap list-unstyled mt-3">
                <li class="mt-2">
                    <a class="text-light text-center text-decoration-none" href="{{ route('student.dashboard') }}">Əsas</a>
                </li>
                <li class="mt-2">
                    <a class="text-light text-center text-decoration-none" href="{{ route('student.mentors') }}">Təlimçilər</a>
                </li>
                <li class="mt-2">
                    <a class="text-light text-center text-decoration-none" href="{{ route('student.telimler') }}">Təlimlər</a>
                </li>
                <li class="mt-2">
                    <a class="text-light text-center text-decoration-none" href="{{ route('student.about') }}">Haqqında</a>
                </li>
            </ul>
        </div>
            ...
            <ul class="d-flex flex-column flex-wrap list-unstyled mt-2">
                ...
                <li class="mt-1">
                    @foreach ($elaqeler as $elaqe)
                        <a class="text-light text-center text-decoration-none" href="#">
                            {!! $elaqe->icon !!}
