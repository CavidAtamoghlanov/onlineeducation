                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="active tab-pane" id="personal_info">
                                <form class="form-horizontal" method="POST" action="{{ route('admin.updateTeacher') }}" id="TeacherInfoForm">
                                    @csrf
                                    <input type="text" value="{{ $teacher->id }}" hidden name="id" id="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="inputSurName"
                                                placeholder="Sur Name" value="{{ $teacher->surname }}" name="surname">
                                    ...
                                    <div class="form-group row">
                                        <div class="offset-sm-2 col-sm-10">
                                            <button type="submit" class="btn btn-danger">edit teacher</button>
                            ...
                            <div class="tab-pane" id="change_password">
                                <form class="form-horizontal" action="{{ route('admin.updateTeacherPassword') }}"  method="POST">
                                    @csrf
                                    <input type="text" value="{{ $teacher->id }}" hidden name="id" id="">
