...
@section('title', 'Müəllim əlavə et')

@section('page_title', 'Müəllim əlavə et')
    ...
    <div class="container-fluid">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Müəllim formu</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="position" name="position"
                            placeholder="Vezife daxil edin" value="{{ old('position') }}">
                        <span class="text-danger">@error('position'){{ $message }}@enderror</span>

                    </div>

                    <div class="form-group">
                        <label for="subject">İxtisas</label>
