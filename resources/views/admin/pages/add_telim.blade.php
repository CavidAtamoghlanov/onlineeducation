...
@section('page_title', 'Təlim əlavə et')
...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="POST" action="{{ route('admin.storemodul') }}">
                        @csrf
                        <div class="card-body">
            ...
            <div class="col-md-6">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="POST" action="{{ route('admin.storesubmodul') }}">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form method="POST" action="{{ route('admin.storetelim') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
